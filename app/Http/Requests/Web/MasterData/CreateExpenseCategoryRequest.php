...
class CreateExpenseCategoryRequest extends FormRequest
{
    ...
    {
        return [
            'label.required' => 'Nama kategori pengeluaran tidak boleh kosong.',
            'label.string' => 'Nama kategori pengeluaran harus berupa string.',
        ];
    }
    ...
    public function failedValidation(Validator $validator)
    {
        ...
        $response = new WithoutDataResource(
            ...
            'FAILED_VALIDATION',
            'Create Kategori Pengeluaran Gagal',
            $messages
        );
