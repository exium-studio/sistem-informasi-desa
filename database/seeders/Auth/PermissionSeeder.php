...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'inventory.create', 'description' => 'Create Inventory', 'group' => 'inventory'],
            ['name' => 'inventory.edit', 'description' => 'Edit Inventory', 'group' => 'inventory'],
            ['name' => 'inventory.delete', 'description' => 'Delete Inventory', 'group' => 'inventory'],
